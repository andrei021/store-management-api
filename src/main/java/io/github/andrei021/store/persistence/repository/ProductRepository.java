...
public class ProductRepository {
    ...
    private static final String SQL_FIND_BY_NAME =
            "SELECT * FROM " + PRODUCT_TABLE_NAME + " WHERE " + PRODUCT_NAME_NORMALIZED_COLUMN + " = :" + PRODUCT_NAME_NORMALIZED_COLUMN;
    ...
    public Optional<ProductDto> findByName(String name) {
        logger.debug("Searching for product with name=[{}]", name);
    ...
    private Optional<ProductDto> searchForProduct(String sql, MapSqlParameterSource params) {
        try {
            ProductDto product = namedJdbcTemplate.queryForObject(sql, params, rowMapper);
